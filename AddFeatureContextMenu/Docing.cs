...
namespace AddFeatureContextMenu
{
    public class WellKnownDockWindow : Intermech.Docking.DockControl, IIODestination, ITreeListColumns
    {
        ...
        /// Заголовок окна
        /// </summary>
        public const string WindowText = "Объекты";
        ...
        /// Название окна
        /// </summary>
        public const string WindowName = "SamplesClient.SampleWindow";
        ...
        private void InitializeComponent()
        {
            ...
            this.navigatorTreeView.StateImageList = null;
            ...
            this.navigatorTreeView.AfterFocusNode += new Intermech.Navigator.Controls.NodeEventHandler(this.navigatorTreeView_AfterFocusNode);
        ...
        public override void Activated()
        {
            ...
            if (!_loaded && !this.DesignMode)
            {
                ...
                Intermech.Navigator.DBObjectTypes.ObjectTypesNodeDescriptor descriptor = new Intermech.Navigator.DBObjectTypes.ObjectTypesNodeDescriptor();

                // Загружаем в дерево содержимое виртуального узла "Объекты"
                this.navigatorTreeView.Build(descriptor);
        ...
        /// <param name="sender">Отправитель</param>
        /// <param name="e">Аргументы события</param>
        private void navigatorTreeView_AfterFocusNode(object sender, Intermech.Navigator.Controls.NodeEventArgs e)
        {
